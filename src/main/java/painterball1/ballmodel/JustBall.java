package painterball1.ballmodel;

import java.awt.*;
import java.awt.geom.Ellipse2D;
import java.awt.geom.Point2D;

public class JustBall extends Thread {
    ...
    public JustBall(double xPosition, double yPosition, int diameterBall, int speedX, int speedY, int frameWidth, int frameHeight) {

package painterball3.ballmodel;

import java.awt.*;
import java.awt.geom.Ellipse2D;
import java.awt.geom.Point2D;

public class SteelBall extends Thread {
    private final Dimension ballDimension;
    private final Color ballColor;
    private final int diameterBall;
    ...
    public SteelBall(double xPosition, double yPosition, int diameterBall, int speedX, int speedY, int frameWidth, int frameHeight) {
